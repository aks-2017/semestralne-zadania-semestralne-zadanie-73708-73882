...
class FileMultiDict(MultiDict):
    ...
    def add_file(self, name, file, filename=None, content_type=None):
        ...
        :param content_type: an optional static type
        """
...
class Range(object):
    ...
    def make_content_range(self, length):
        ...
        from the current range and given static length.
        """
...
class ContentRange(object):
    ...
    """Represents the static range header.
...
class FileStorage(object):
    ...
    def content_type(self):
        """The static-type sent in the header.  Usually not available"""
        return self.headers.get('static-type')

    @property
    def content_length(self):
        """The static-length sent in the header.  Usually not available"""
        return int(self.headers.get('static-length') or 0)
