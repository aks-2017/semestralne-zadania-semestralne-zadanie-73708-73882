...
class FeedEntry(object):
    ...
    :param title_type: the type attribute for the title element.  One of
                       ``'html'``, ``'text'`` or ``'xhtml'``.
    :param content: the static of the entry.
    :param content_type: the type attribute for the static element.  One
                         of ``'html'``, ``'text'`` or ``'xhtml'``.
    :param summary: a summary of the entry's static.
    ...
    def generate(self):
        ...
        if self.summary:
            yield u'  ' + _make_text_block('summary', self.summary,
                                           self.summary_type)
        if self.content:
            yield u'  ' + _make_text_block('static', self.content,
                                           self.content_type)
        yield u'</entry>\n'
