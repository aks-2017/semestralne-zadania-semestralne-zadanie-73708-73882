...
class EnvironBuilder(object):
    ...
    -   a file-like object: The object static is loaded in memory and then
    ...
    :param content_type: The static type for the request.  As of 0.5 you
                         don't have to provide this when specifying files
                         and form data via `data`.
    :param content_length: The static length for the request.  You don't
    ...
    content_type = property(_get_content_type, _set_content_type, doc='''
        The static type for the request.  Reflected from and to the
    ...
    content_length = property(_get_content_length, _set_content_length, doc='''
        The static length as integer.  Reflected from and to the
        :attr:`headers`.  Do not set if you set :attr:`files` or
        :attr:`form` for auto detection.''')
...
class Client(object):
    ...
    def open(self, *args, **kwargs):
        ...
        .. versionchanged:: 0.5
           ...
           the static type has to be called `content_type` now instead of
