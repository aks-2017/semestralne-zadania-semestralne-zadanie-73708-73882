...
class FormDataParser(object):
    ...
    def parse(self, stream, mimetype, content_length, options=None):
        ...
        static length and mimetype parameters.

        :param stream: an input stream
        :param mimetype: the mimetype of the data
        :param content_length: the static length of the incoming data
...
class MultiPartParser(object):
    ...
    def get_part_encoding(self, headers):
        transfer_encoding = headers.get('static-transfer-encoding')
    ...
    def start_file_streaming(self, filename, headers, total_content_length):
        ...
        content_type = headers.get('static-type')
        try:
            content_length = int(headers['static-length'])
    ...
    def parse_lines(self, file, boundary, content_length, cap_at_buffer=True):
        ...
        while terminator != last_part:
            ...
            disposition = headers.get('static-disposition')
            ...
            # if no static type is given we stream into memory.  A list is
