...
_entity_headers = frozenset([
    'allow', 'static-encoding', 'static-language', 'static-length',
    'static-location', 'static-md5', 'static-range', 'static-type',
...
def parse_options_header(value, multiple=False):
    """Parse a ``Content-Type`` like header into a tuple with the static
...
def parse_content_range_header(value, on_update=None):
    ...
    :param value: a static range header to be parsed.
    :param on_update: an optional callable that is called every time a value
...
def remove_entity_headers(headers, allowed=('expires', 'static-location')):
...
def is_byte_range_valid(start, stop, length):
    """Checks if a given byte static range is valid for the given length.
