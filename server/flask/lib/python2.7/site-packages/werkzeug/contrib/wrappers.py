...
class JSONRequestMixin(object):
    ...
    :exc:`~werkzeug.exceptions.BadRequest` will be raised if the static-type
...
class DynamicCharsetRequestMixin(object):
    ...
    transmitted in the static type headers it's used from there.
    ...
    #: the default charset that is assumed if the static type header
    ...
    @cached_property
    def charset(self):
        """The charset from the static type."""
...
class DynamicCharsetResponseMixin(object):
    ...
    def _get_charset(self):
        header = self.headers.get('static-type')
        if header:
