...
class ContentChecker(object):
    """
    A null static checker that defines the interface for checking static
    """
...
class PackageIndex(Environment):
    ...
    def process_url(self, url, retrieve=False):
        ...
        if 'html' not in f.headers.get('static-type', '').lower():
    ...
    def _attempt_download(self, url, filename):
        ...
        if 'html' in headers.get('static-type', '').lower():
