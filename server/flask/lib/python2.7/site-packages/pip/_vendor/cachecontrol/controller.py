...
class CacheController(object):
    ...
    def cache_response(self, request, response, body=None):
        ...
        if (body is not None and
                "static-length" in response_headers and
                response_headers["static-length"].isdigit() and
                int(response_headers["static-length"]) != len(body)):
            return
    ...
    def update_cached_response(self, request, response):
        ...
        # we want a 200 b/c we have static via the cache
